...
;; *************** function _main *****************
;; Defined at:
;;		line 57 in file "C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2.c"
...
psect	maintext,global,class=CODE,delta=2,split=1
	file	"C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2.c"
	line	57
global __pmaintext
...
l562:	
;LE7-2.c: 59: TRISB = 0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(134)^080h	;volatile
	line	60
;LE7-2.c: 60: PORTB = 0x00;
...
l566:	
;LE7-2.c: 62: init_I2C_Slave(0x10);
	movlw	(010h)
...
;; Defined at:
;;		line 12 in file "C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2.c"
;; Parameters:    Size  Location     Type
...
l522:	
;LE7-2.c: 16: SSPCON = 0x36;
	movlw	(036h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(20)	;volatile
	line	18
;LE7-2.c: 18: SSPCON2 = 0x01;
	movlw	(01h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(145)^080h	;volatile
	line	20
;LE7-2.c: 20: SSPSTAT = 0x80;
	movlw	(080h)
	movwf	(148)^080h	;volatile
	line	21
;LE7-2.c: 21: SSPADD = slave_add;
...
;; *************** function _ISR *****************
;; Defined at:
;;		line 28 in file "C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
i1l532:	
;LE7-2.c: 30: unsigned char temp;
;LE7-2.c: 31: CKP = 0;
	bcf	(164/8),(164)&7	;volatile
	line	32
;LE7-2.c: 32: if(WCOL || SSPOV) {
...
i1l544:	
;LE7-2.c: 37: }
;LE7-2.c: 39: if(!SSPSTATbits.D_nA && !SSPSTATbits.R_nW){
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
i1l49:	
;LE7-2.c: 46: else if(!SSPSTATbits.D_nA && SSPSTATbits.R_nW){
	btfsc	(148)^080h,5	;volatile
	goto	u6_21
	goto	u6_20
u6_21:
