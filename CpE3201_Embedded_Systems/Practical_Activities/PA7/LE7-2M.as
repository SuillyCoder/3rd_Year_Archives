...
;; *************** function _main *****************
;; Defined at:
;;		line 79 in file "C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2_M.c"
...
psect	maintext,global,class=CODE,delta=2,split=1
	file	"C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2_M.c"
	line	79
global __pmaintext
...
l566:	
;LE7-2_M.c: 81: TRISB = 0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(134)^080h	;volatile
	line	82
;LE7-2_M.c: 82: PORTB = 0x00;
...
l572:	
;LE7-2_M.c: 86: {
;LE7-2_M.c: 87: I2C_Start();
	fcall	_I2C_Start
	line	88
	
l574:	
;LE7-2_M.c: 88: I2C_Send(0x10);
	movlw	(010h)
	fcall	_I2C_Send
	line	89
	
l576:	
;LE7-2_M.c: 89: I2C_Send(PORTD);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(8),w	;volatile
	fcall	_I2C_Send
...
l578:	
;LE7-2_M.c: 90: I2C_Stop();
	fcall	_I2C_Stop
	line	91
	
l580:	
;LE7-2_M.c: 91: _delay((unsigned long)((200)*(4000000/4000.0)));
	opt asmopt_off
movlw  2
movwf	((??_main+0)+0+2),f
movlw	4
...
l582:	
;LE7-2_M.c: 92: I2C_Start();
	fcall	_I2C_Start
	line	93
	
l584:	
;LE7-2_M.c: 93: I2C_Send(0x11);
	movlw	(011h)
	fcall	_I2C_Send
	line	94
	
l586:	
;LE7-2_M.c: 94: PORTB = I2C_Receive(0);
	movlw	(0)
	fcall	_I2C_Receive
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l588:	
;LE7-2_M.c: 97: I2C_Stop();
	fcall	_I2C_Stop
	line	98
	
l590:	
;LE7-2_M.c: 98: _delay((unsigned long)((200)*(4000000/4000.0)));
	opt asmopt_off
movlw  2
movwf	((??_main+0)+0+2),f
movlw	4
...
;; Defined at:
;;		line 15 in file "C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2_M.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l528:	
;LE7-2_M.c: 16: TRISC3 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	bsf	(1083/8)^080h,(1083)&7	;volatile
	line	17
;LE7-2_M.c: 17: TRISC4 = 1;
	bsf	(1084/8)^080h,(1084)&7	;volatile
	line	18
	
l530:	
;LE7-2_M.c: 18: SSPCON = 0x28;
	movlw	(028h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(20)	;volatile
...
l534:	
;LE7-2_M.c: 21: SSPSTAT = 0x00;
	clrf	(148)^080h	;volatile
	line	22
;LE7-2_M.c: 22: SSPADD = 0x09;
	movlw	(09h)
...
;; *************** function _I2C_Stop *****************
;; Defined at:
;;		line 39 in file "C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2_M.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _I2C_Start *****************
;; Defined at:
;;		line 34 in file "C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2_M.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _I2C_Send *****************
;; Defined at:
;;		line 58 in file "C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2_M.c"
;; Parameters:    Size  Location     Type
...
l544:	
;LE7-2_M.c: 61: I2C_Wait();
	fcall	_I2C_Wait
	line	63
	
l546:	
;LE7-2_M.c: 63: SSPBUF = data;
...
;; Defined at:
;;		line 66 in file "C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2_M.c"
;; Parameters:    Size  Location     Type
...
l548:	
;LE7-2_M.c: 67: unsigned char temp;
;LE7-2_M.c: 68: I2C_Wait();
	fcall	_I2C_Wait
	line	69
...
;LE7-2_M.c: 69: RCEN = 1;
	...
	line	70
;LE7-2_M.c: 70: I2C_Wait();
	fcall	_I2C_Wait
	line	71
	
l552:	
;LE7-2_M.c: 71: temp = SSPBUF;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(19),w	;volatile
...
l554:	
;LE7-2_M.c: 72: I2C_Wait();
	fcall	_I2C_Wait
	line	73
	
l556:	
;LE7-2_M.c: 73: ACKDT = (ack)?0:1;
...
l558:	
;LE7-2_M.c: 74: ACKEN = 1;
	bsf	(1164/8)^080h,(1164)&7	;volatile
	line	75
;LE7-2_M.c: 75: return temp;
...
;; *************** function _I2C_Wait *****************
;; Defined at:
;;		line 27 in file "C:\Users\enzoa\OneDrive\Documents\GitHub\3rd_Year_Archives\CpE3201_Embedded_Systems\Practical_Activities\PA7\LE7-2_M.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l522:	
;LE7-2_M.c: 29: while((SSPCON2 & 0x1F) || (SSPSTAT & 0x04));
	goto	l524
